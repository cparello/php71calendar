...
class Calendar extends DB_Connect
{
     ...
     * @return void
     */
    public function __construct($dbo = NULL, $useDate = NULL)//$db = NULL,
    {
        /*
 ...
 */
    ...
    public function displayForm()
    {
        ...
        <form action="../../events_calendar/public/assets/inc/process.inc.php" method="post">
            <fieldset>
                ...
                or <a href="../../events_calendar/public/index.php">cancel</a>
            </fieldset>
        </form>
FORM_MARKUP;
    }
    ...
    public function confirmDelete($id)
    {
            ...
            && $_POST['token']==$_SESSION['token'] )
        {
            ...
            if ( $_POST['confirm_delete']=="Yes, Delete It" )
            {
                ...
                try
                {
                    ...
                    $stmt->execute();
                    $stmt->closeCursor();
                    header("Location: ../../events_calendar/public/index.php");
                    return;
                }
                catch ( Exception $e )
                {
         ...
         */
        if ( !is_object($event) ) { header("Location: ../../events_calendar/public/index.php"); }

        return <<<CONFIRM_DELETE

    <form action="../../events_calendar/public/confirmdelete.php" method="post">
        <h2>
...
CONFIRM_DELETE;
    ...
    private function _loadEventData($id = NULL)
    {
        ...
        error_log("XXXXXXXXXXXXXXXXXX $id");
        /*
...
ADMIN_OPTIONS;
    ...
    <form action="../../events_calendar/public/admin.php" method="post">
        <p>
